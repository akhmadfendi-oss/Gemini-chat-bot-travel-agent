...
app.use(express.static(path.join(__dirname, '..'))); // Menyajikan file frontend statis dari root

// Inisialisasi Gemini SDK
const ai = new GoogleGenAI({ apiKey: process.env.GEMINI_API_KEY });

// Endpoint Chat (Menangkap '/' untuk Vercel Serverless, dan '/api/chat' untuk Lokal)
...
// Hanya jalankan app.listen jika dipanggil secara lokal, bukan oleh Vercel
